(*
  DM : traitement d'images
  2022-2023
  Lycée Thiers
  Professeur : Yves Noyer *)
(* Le code fourni dans ce fichier est donné par notre professeur *)
(* La fonction display a été modifié par moi-même *)
(* La fonction negative sert d'exemple de tranformations d'images *)
